...
namespace psm::resolve
{
        ...
        -> net::awaitable<resolve_result>
    {
        ...
        // 创建 UDP socket，shared_ptr 确保 timer 回调安全
        ...
        // 检查 RCODE（0 = NoError, 3 = NXDomain 均视为可处理）
        ...
        -> net::awaitable<resolve_result>
    {
        ...
        // 创建 TCP socket，shared_ptr 确保 timer 回调安全
