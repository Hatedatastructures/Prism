...
namespace psm::handshake::restls
{
    ...
    namespace
    {
            ...
            -> net::awaitable<std::shared_ptr<net::ip::tcp::socket>>
        {
            ...
            if (ec)
            {
                diagnose::warn(prefix_, "restls: backend connection failed: {}", ec.message());
                co_return nullptr;
            }
            co_return sock;
        }
        ...
        -> net::awaitable<handshake::handshake_result>
    {
        ...
        diagnose::debug(prefix_, "restls: connecting to backend {}:{}", backend_host, backend_port);
        ...
        {
            diagnose::warn(prefix_, "restls: failed to read ServerHello");
            result.error = fault::code::connection_refused;
            result.polluted = true;
            co_return result;
        }
        ...
        {
            diagnose::warn(prefix_, "restls: clientFinished not captured");
