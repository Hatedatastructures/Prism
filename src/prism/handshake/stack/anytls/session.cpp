...
namespace psm::handshake::anytls
{
    ...
    auto anytls_session::recv_loop() -> net::awaitable<void>
    {
        try
        {
            ...
            while (!closed_)
            {
                ...
                {
                    diagnose::debug(prefix_, "connection closed during header read");
                    break;
                }
        ...
        {
            diagnose::error(prefix_, "recv_loop exception, closing session");
        }
        ...
        -> net::awaitable<void>
    {
        ...
        case command::heart_req:
        {
            ...
            {
                diagnose::debug(prefix_, "heartbeat response sent");
            }
            break;
        }
        case command::waste:
    ...
    auto anytls_session::on_settings(memory::vector<std::uint8_t> payload) -> net::awaitable<void>
    {
        ...
        diagnose::debug(prefix_, "Settings received, version={}", peer_version_);
    }
