...
namespace
{
     ...
     */
    TEST(HandshakeTimeout, ReadRawTlsFrameTimeout)
    {
        net::io_context ioc;
     ...
     */
    TEST(HandshakeTimeout, ReadRawTlsFrameEofNoDeadline)
    {
        net::io_context ioc;
     ...
     */
    TEST(HandshakeTimeout, ReadRawTlsFrameSuccessBeforeDeadline)
    {
        net::io_context ioc;
     ...
     * 验证握手返回超时错误码。
     */
    TEST(HandshakeTimeout, VlessHandshakeTimeout)
    {
        net::io_context ioc;
     ...
     */
    TEST(HandshakeTimeout, TrojanHandshakeTimeout)
    {
        net::io_context ioc;
     ...
     */
    TEST(HandshakeTimeout, DeadlineTimerExpiry)
    {
        net::io_context ioc;
        ...
        auto coro = [&]() -> net::awaitable<void>
        {
            ...
            EXPECT_TRUE(!ec) << "timer should expire without error";
            *expired = true;
        };
     ...
     */
    TEST(HandshakeTimeout, DeadlineTimerCancellation)
    {
        net::io_context ioc;
        ...
        auto coro = [&]() -> net::awaitable<void>
        {
            ...
            EXPECT_TRUE(*inner_result == boost::asio::error::operation_aborted)
     ...
     */
    TEST(HandshakeTimeout, DeadlineCancelsRead)
    {
        net::io_context ioc;
