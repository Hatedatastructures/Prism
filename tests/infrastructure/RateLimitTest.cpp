...
namespace
{
    ...
    {
        psmtest::rate::token_bucket bucket(3, std::chrono::milliseconds(100), 1);
    ...
    {
        psmtest::rate::token_bucket bucket(5, std::chrono::milliseconds(100), 2);
    ...
    {
        psmtest::rate::token_bucket bucket(10, std::chrono::milliseconds(50), 1);
        // 突发取 10（桶满）
    ...
    {
        psmtest::rate::token_bucket bucket(1000, std::chrono::milliseconds(1000), 100);
    ...
    {
        net::io_context ioc;
        psmtest::rate::token_bucket bucket(2, std::chrono::milliseconds(100), 1);
        psmtest::middleware::builtin::throttle_middleware mw(&bucket, fake_clock);

        psmtest::middleware::context ctx;
        psmtest::shared_transmission inbound;

        psmtest::fault::code r1 = psmtest::fault::code::success;
        psmtest::fault::code r2 = psmtest::fault::code::success;
        psmtest::fault::code r3 = psmtest::fault::code::success;
        ...
        ioc.run();
        ASSERT_FALSE(ep);
        EXPECT_EQ(r1, psmtest::fault::code::success);
        EXPECT_EQ(r2, psmtest::fault::code::success);
        EXPECT_EQ(r3, psmtest::fault::code::blocked);
    }

    TEST(BanMiddleware, ThresholdBans)
    {
        fake_ms = 0;
        psmtest::middleware::builtin::ban_middleware ban(3, 1000, fake_clock);
    ...
    {
        fake_ms = 0;
        psmtest::middleware::builtin::ban_middleware ban(2, 1000, fake_clock);
    ...
    TEST(BanMiddleware, HandleBlocksWhenBanned)
    {
        net::io_context ioc;
        fake_ms = 0;
        psmtest::middleware::builtin::ban_middleware ban(1, 1000, fake_clock);
        ...
        ioc.run();
        ASSERT_FALSE(ep);
        EXPECT_EQ(rc, psmtest::fault::code::blocked);
    }
