        ...
        run_coro(ioc, [&]() -> net::awaitable<void>
            ...
            auto server_coro = [&]() -> net::awaitable<void>
            {
                auto [err, req, conn] = co_await tuic::accept(
                    std::make_shared<memory_stream>(std::move(b)), tuic::server_config{make_uuid(), "pw"});
                if (err != error::none)
                {
            ...
            auto [herr, cli] = co_await tuic::connect(
                std::make_shared<memory_stream>(std::move(a)), tuic::client_config{make_uuid(), "pw"}, make_dst());
