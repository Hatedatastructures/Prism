...
namespace
{
    TEST(VlessConnPure, UuidAllZeros)
    {
        ...
        EXPECT_EQ(str, "00000000-0000-0000-0000-000000000000") << "uuid: all zeros";
    }
    ...
    TEST(VlessConnPure, UuidAllFF)
    {
        ...
        uuid.fill(0xFF);
        auto str = psm::protocol::vless::uuid_to_string(uuid);
        EXPECT_EQ(str, "ffffffff-ffff-ffff-ffff-ffffffffffff") << "uuid: all 0xFF";
    }
    ...
    TEST(VlessConnPure, UuidLength)
    {
        std::array<std::uint8_t, 16> uuid{};
        auto str = psm::protocol::vless::uuid_to_string(uuid);
        EXPECT_EQ(str.size(), 36) << "uuid: length=36";
    }
    ...
    TEST(VlessConnPure, UuidDashPositions)
    {
        ...
        EXPECT_EQ(str[18], '-') << "uuid: dash at 18";
