...
namespace
{
    TEST(TrojanFraming, ParseCredentialValid)
    {
        ...
        EXPECT_EQ(ec, psm::fault::code::success) << "credential valid: success";
    ...
    TEST(TrojanFraming, ParseCredentialShort)
    {
        ...
        EXPECT_EQ(ec, psm::fault::code::bad_message) << "credential short: bad_message";
    }
    ...
    TEST(TrojanFraming, ParseCredentialInvalidChar)
    {
        ...
        auto [ec, cred] = psm::protocol::trojan::format::parse_credential(buf);
        EXPECT_EQ(ec, psm::fault::code::protocol_error) << "credential invalid char: protocol_error";
    }
    ...
    TEST(TrojanFraming, ParseCrlfValid)
    {
        ...
        EXPECT_EQ(ec, psm::fault::code::success) << "crlf valid: success";
    }
    ...
    TEST(TrojanFraming, ParseCrlfShort)
    {
        const std::uint8_t buf[] = {'\r'};
        auto ec = psm::protocol::trojan::format::parse_crlf(buf);
        EXPECT_EQ(ec, psm::fault::code::bad_message) << "crlf short: bad_message";
    }
    ...
    TEST(TrojanFraming, ParseCrlfWrong)
    {
        ...
        auto ec = psm::protocol::trojan::format::parse_crlf(buf);
        EXPECT_EQ(ec, psm::fault::code::protocol_error) << "crlf wrong: protocol_error";
    }
    ...
    TEST(TrojanFraming, ParseCmdAtypValid)
    {
        ...
        EXPECT_EQ(ec, psm::fault::code::success) << "cmd_atyp valid: success";
        EXPECT_EQ(result.cmd, psm::protocol::trojan::command::connect) << "cmd_atyp cmd=connect";
        EXPECT_EQ(result.atyp, psm::protocol::trojan::address_type::domain) << "cmd_atyp atyp=domain";
    }
    ...
    TEST(TrojanFraming, ParseCmdAtypShort)
    {
        ...
        auto [ec, result] = psm::protocol::trojan::format::parse_cmd_atyp(buf);
        EXPECT_EQ(ec, psm::fault::code::bad_message) << "cmd_atyp short: bad_message";
    }
    ...
    TEST(TrojanFraming, BuildParseUdpIpv4)
    {
        ...
        EXPECT_EQ(ec, psm::fault::code::success) << "build udp ipv4: success";

        auto [pec, result] = psm::protocol::trojan::format::parse_udp_pkt(out);
        EXPECT_EQ(pec, psm::fault::code::success) << "parse udp ipv4: success";
        EXPECT_EQ(result.destination_port, 443) << "parse udp ipv4: port=443";
        EXPECT_EQ(result.payload_size, 2) << "parse udp ipv4: payload_size=2";
    }
    ...
    TEST(TrojanFraming, BuildParseUdpIpv6)
    {
        ...
        auto ec = psm::protocol::trojan::format::build_udp_pkt(frame, payload, out);
        EXPECT_EQ(ec, psm::fault::code::success) << "build udp ipv6: success";

        auto [pec, result] = psm::protocol::trojan::format::parse_udp_pkt(out);
        EXPECT_EQ(pec, psm::fault::code::success) << "parse udp ipv6: success";
        EXPECT_EQ(result.destination_port, 8080) << "parse udp ipv6: port=8080";
        EXPECT_EQ(result.payload_size, 1) << "parse udp ipv6: payload_size=1";
    }
    ...
    TEST(TrojanFraming, BuildParseUdpDomain)
    {
        ...
        auto ec = psm::protocol::trojan::format::build_udp_pkt(frame, payload, out);
        EXPECT_EQ(ec, psm::fault::code::success) << "build udp domain: success";

        auto [pec, result] = psm::protocol::trojan::format::parse_udp_pkt(out);
        EXPECT_EQ(pec, psm::fault::code::success) << "parse udp domain: success";
        EXPECT_EQ(result.destination_port, 443) << "parse udp domain: port=443";
        EXPECT_EQ(result.payload_size, 2) << "parse udp domain: payload_size=2";
    }
    ...
    TEST(TrojanFraming, ParseUdpTooShort)
    {
        ...
        EXPECT_EQ(ec, psm::fault::code::bad_message) << "parse udp short: bad_message";
    }
    ...
    TEST(TrojanFraming, ParseUdpBadCrlf)
    {
        ...
        buf[10] = std::byte{'Y'};
        auto [ec, result] = psm::protocol::trojan::format::parse_udp_pkt(buf);
        EXPECT_EQ(ec, psm::fault::code::protocol_error) << "parse udp bad crlf: protocol_error";
    }
    ...
    TEST(TrojanFraming, BuildUdpEmptyPayload)
    {
        ...
        EXPECT_EQ(ec, psm::fault::code::success) << "build udp empty payload: success";

        auto [pec, result] = psm::protocol::trojan::format::parse_udp_pkt(out);
        EXPECT_EQ(pec, psm::fault::code::success) << "parse udp empty payload: success";
        EXPECT_EQ(result.payload_size, 0) << "parse udp empty payload: payload_size=0";
    }
