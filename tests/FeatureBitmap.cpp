...
void TestFeatureBitmapBuild()
{
    ...
    runner.Check(psm::protocol::tls::has_feature(bitmap, psm::protocol::tls::has_sni), "Should have has_sni bit");
    ...
    runner.Check(psm::protocol::tls::has_feature(bitmap, psm::protocol::tls::has_x25519), "Should have has_x25519 bit");
    ...
    runner.Check(psm::protocol::tls::has_feature(bitmap, psm::protocol::tls::has_full_session_id), "Should have has_full_session_id bit");
    ...
    runner.Check(psm::protocol::tls::has_feature(bitmap, psm::protocol::tls::session_id_non_standard), "Should have session_id_non_standard bit");
...
void TestFeatureBitmapHasAllFeatures()
{
    ...
    runner.Check(psm::protocol::tls::has_all_features(bitmap, combined), "Should have all three features");

    // 测试部分匹配
    auto partial = psm::protocol::tls::has_sni | psm::protocol::tls::has_ech;
    runner.Check(!psm::protocol::tls::has_all_features(bitmap, partial), "Should not have ECH");
