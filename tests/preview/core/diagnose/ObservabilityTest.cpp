...
namespace
{
    ...
    {
        preview::diagnose::hdr_histogram h(1024);
        EXPECT_EQ(h.count(), 0);
    ...
    {
        preview::diagnose::hdr_histogram h(16);
    ...
    {
        preview::diagnose::hdr_histogram h(64);
    ...
    {
        preview::diagnose::ewma_meter meter(1000);
    ...
    {
        preview::diagnose::sample_tracer tracer(1); // 全采样
    ...
    {
        preview::diagnose::sample_tracer tracer(4); // 1/4
    ...
    {
        preview::diagnose::sample_tracer tracer(1, 16); // 小环
