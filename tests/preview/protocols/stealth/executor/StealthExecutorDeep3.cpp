 ...
 */
    ...
    public:
        ...
        handshake::scheme_category category_ = handshake::scheme_category::facade;
        ...
        [[nodiscard]] auto category() const noexcept -> handshake::scheme_category override
        {
            return category_;
        }
 ...
 */
    auto make_mock(std::string_view name, handshake::handshake_result result, bool active = true,
                   handshake::scheme_category cat = handshake::scheme_category::facade)
 ...
 */
    ...
    TEST(StealthExecutorDeep3, ExecuteSingle_SetsSchemeName)
    {
        ...
        auto mock = make_mock("test_scheme", handshake::handshake_result{});
        registry.add(mock);
    ...
    TEST(StealthExecutorDeep3, ExecuteSingle_PreservesTransport)
    {
        ...
        EXPECT_EQ(result.detected, psm::connect::protocol_type::socks5)
            << "execute_single preserves detected";
    }
    ...
    TEST(StealthExecutorDeep3, ExecutePipeline_StackSuccess)
    {
        ...
        auto mock = make_mock("stack_ok", std::move(preset), true, handshake::scheme_category::stack);
        handshake::scheme_registry registry;
        registry.add(mock);
    ...
    TEST(StealthExecutorDeep3, ExecutePipeline_StackFailContinue)
    {
        ...
        auto stack_fail =
            make_mock("stack_fail", std::move(fail_preset), true, handshake::scheme_category::stack);
    ...
    TEST(StealthExecutorDeep3, ExecutePipeline_SchemeDisabled_Skipped)
    {
        ...
        auto disabled = make_mock("disabled", handshake::handshake_result{}, false);
    ...
    TEST(StealthExecutorDeep3, Execute_MultipleCandidatesFirstWins)
    {
        ...
        handshake::handshake_result second_ok;
