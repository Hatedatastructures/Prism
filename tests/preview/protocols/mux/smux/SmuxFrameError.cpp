...
namespace
{
    ...
    TEST(SmuxFrameError, ParseHeaderEmpty)
    {
        ...
        EXPECT_EQ(Smux::ParseHeader(Empty, out), Error::need_more)
    ...
    TEST(SmuxFrameError, ParseHeaderTooShort)
    {
        ...
        Smux::FrameHeader out{};
        EXPECT_EQ(Smux::ParseHeader(short_buf, out), Error::need_more)
            << "ParseHeader: 4 Bytes -> need_more";
    }

    TEST(SmuxFrameError, ParseHeaderBadVersion)
    {
        auto wire = Smux::Build(1);
    ...
    {
        const auto Frame = Smux::Build(42);
        Smux::FrameHeader out{};
