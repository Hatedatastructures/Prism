...
namespace
{
    ...
    {
        psm::handshake::native::native scheme;
        EXPECT_EQ(scheme.unique(), false) << "native: unique == false";
    }
    ...
    TEST(NativeScheme, ActiveEnabled)
    {
        ...
        EXPECT_EQ(scheme.active(cfg), true) << "native: active when enabled=true";
    }
    ...
    TEST(NativeScheme, ActiveDisabled)
    {
        ...
        EXPECT_EQ(scheme.active(cfg), false) << "native: inactive when enabled=false";
    }
    ...
    TEST(NativeScheme, ActiveDefault)
    {
        ...
        EXPECT_EQ(scheme.active(cfg), true) << "native: active by default";
    }
