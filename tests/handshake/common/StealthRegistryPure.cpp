...
namespace
{
    TEST(StealthRegistryPure, InstanceSingleton)
    {
        ...
        EXPECT_EQ(&a, &b) << "instance: same reference";
    }
    ...
    TEST(StealthRegistryPure, FindReality)
    {
        ...
        EXPECT_NE(s, nullptr) << "find: reality found";
    }
    ...
    TEST(StealthRegistryPure, FindShadowtls)
    {
        ...
        EXPECT_NE(s, nullptr) << "find: shadowtls found";
    }
    ...
    TEST(StealthRegistryPure, FindNonexistent)
    {
        ...
        EXPECT_EQ(s, nullptr) << "find: nonexistent returns null";
    }
    ...
    TEST(StealthRegistryPure, AllReturnsSameRef)
    {
        ...
        EXPECT_EQ(&v1, &v2) << "all: same reference";
    }
