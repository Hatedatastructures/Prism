...
namespace
{
    ...
    TEST(TrustTunnelSchemeDeep, VerifyBasicAuthNoPrefix)
    {
        ...
        auto result = psm::handshake::trusttunnel::verify_basic_auth("admin:pass", users);
    ...
    TEST(TrustTunnelSchemeDeep, VerifyBasicAuthWrongPrefix)
    {
        vector<tt::user> users;
        users.push_back({string("admin"), string("pass")});
        auto result = psm::handshake::trusttunnel::verify_basic_auth("Bearer xyz", users);
    ...
    {
        vector<tt::user> users;
        auto result = psm::handshake::trusttunnel::verify_basic_auth("Basic dGVzdA==", users);
    ...
    TEST(TrustTunnelSchemeDeep, VerifyBasicAuthCorrectCredentials)
    {
        ...
        vector<tt::user> users;
        users.push_back({string("admin"), string("pass")});
        auto result = psm::handshake::trusttunnel::verify_basic_auth("Basic YWRtaW46cGFzcw==", users);
    ...
    TEST(TrustTunnelSchemeDeep, VerifyBasicAuthWrongPassword)
    {
        vector<tt::user> users;
        users.push_back({string("admin"), string("pass")});
        auto result = psm::handshake::trusttunnel::verify_basic_auth("Basic YWRtaW46d3Jvbmc=", users);
    ...
    TEST(TrustTunnelSchemeDeep, VerifyBasicAuthMultipleUsers)
    {
        ...
        auto result = psm::handshake::trusttunnel::verify_basic_auth("Basic dXNlcjpwYXNzMg==", users);
    ...
    TEST(TrustTunnelSchemeDeep, VerifyBasicAuthEmptyHeader)
    {
        vector<tt::user> users;
        users.push_back({string("admin"), string("pass")});
        auto result = psm::handshake::trusttunnel::verify_basic_auth("", users);
    ...
    TEST(TrustTunnelSchemeDeep, VerifyBasicAuthJustPrefix)
    {
        ...
        auto result = psm::handshake::trusttunnel::verify_basic_auth("Basic ", users);
    ...
    TEST(TrustTunnelSchemeDeep, ResolveStreamTargetInvalidPort)
    {
        ...
        auto info = psm::handshake::trusttunnel::resolve_stream_target(11, headers);
