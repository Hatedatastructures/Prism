...
namespace
{
    ...
    {
        psm::memory::vector<psm::handshake::trusttunnel::user> users;
        auto result = psm::handshake::trusttunnel::verify_basic_auth("Token abc", users);
    ...
    {
        psm::memory::vector<psm::handshake::trusttunnel::user> users;
        auto result = psm::handshake::trusttunnel::verify_basic_auth("Basic dGVzdDpwYXNz", users);
    ...
    TEST(TrustTunnelAuthPure, VerifyBasicAuthWrongPassword)
    {
        ...
        auto result = psm::handshake::trusttunnel::verify_basic_auth("Basic YWRtaW46d3Jvbg==", users);
