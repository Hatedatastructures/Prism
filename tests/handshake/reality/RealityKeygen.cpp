...
namespace
{
    ...
    TEST(RealityKeygen, DeriveAppKeys)
    {
        ...
        auto [ec_hs, keys] = psm::handshake::reality::derive_hs_keys(shared_secret, chello_msg, shello_msg);
    ...
    TEST(RealityKeygen, ComputeVerify)
    {
        ...
        finished_key[0] = 0xCC;
        auto verify3 = psm::handshake::reality::compute_verify(finished_key, transcript_hash);
