...
namespace
{
    TEST(ListenerPure, MakeAffinityIPv4)
    {
        ...
        EXPECT_EQ(result, 0xC0A80101ULL) << "make_affinity IPv4: 192.168.1.1";
    }
    ...
    TEST(ListenerPure, MakeAffinityIPv4Loopback)
    {
        ...
        auto result = psm::runtime::front::listener::make_affinity(ep);
        EXPECT_EQ(result, 0x7F000001ULL) << "make_affinity IPv4: 127.0.0.1";
    }
    ...
    TEST(ListenerPure, MakeAffinityIPv6Loopback)
    {
        ...
        EXPECT_EQ(result, 1ULL) << "make_affinity IPv6: ::1";
    }
    ...
    TEST(ListenerPure, MakeAffinityZeroAddress)
    {
        ...
        auto result = psm::runtime::front::listener::make_affinity(ep);
        EXPECT_EQ(result, 0ULL) << "make_affinity IPv4: 0.0.0.0";
    }
} // namespace
