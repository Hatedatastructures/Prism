...
template <>
struct glz::meta<ngx::resolve::dns_protocol>
{
    static constexpr auto value = glz::enumerate(
        "udp", ngx::resolve::dns_protocol::udp,
        "tcp", ngx::resolve::dns_protocol::tcp,
        "tls", ngx::resolve::dns_protocol::tls,
        "https", ngx::resolve::dns_protocol::https);
};

template <>
struct glz::meta<ngx::resolve::resolve_mode>
{
    static constexpr auto value = glz::enumerate(
        "fastest", ngx::resolve::resolve_mode::fastest,
        "first", ngx::resolve::resolve_mode::first,
        "fallback", ngx::resolve::resolve_mode::fallback);
};

template <>
struct glz::meta<ngx::resolve::dns_remote>
{
    using T = ngx::resolve::dns_remote;
...
template <>
struct glz::meta<ngx::resolve::address_rule>
{
    using T = ngx::resolve::address_rule;
    static constexpr auto value = glz::object(
        "domain", &T::domain,
        "negative", &T::negative);
};
...
template <>
struct glz::meta<ngx::resolve::cname_rule>
{
    using T = ngx::resolve::cname_rule;
    static constexpr auto value = glz::object(
        "domain", &T::domain,
        "target", &T::target);
};
...
template <>
struct glz::meta<ngx::resolve::config>
{
    using T = ngx::resolve::config;
    static constexpr auto value = glz::object(
        "servers", &T::servers,
        "mode", &T::mode,
        "timeout_ms", &T::timeout_ms,
