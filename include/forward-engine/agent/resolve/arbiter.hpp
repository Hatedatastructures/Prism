...
namespace ngx::agent::resolve
{
    ...
    public:
         ...
         */
        arbiter(tcpool &pool, rule::blacklist &blacklist, udpcache &udp_dns,
            ...
            -> net::awaitable<std::pair<fault::code, net::ip::udp::socket>>
        {
            ...
            {
                co_return std::pair{fault::code::blocked, net::ip::udp::socket{executor_}};
            }
            ...
            -> net::awaitable<std::pair<fault::code, net::ip::udp::endpoint>>
        {
            if (blacklist_.domain(host))
            {
                co_return std::pair{fault::code::blocked, net::ip::udp::endpoint{}};
            }
