...
namespace ngx::channel
{
    ...
    public:
         ...
         */
        explicit tcpool(net::io_context &ioc, const memory::resource_pointer resource = memory::current_resource(),
        ...
        tcpool(const tcpool &) = delete;
        tcpool &operator=(const tcpool &) = delete;
