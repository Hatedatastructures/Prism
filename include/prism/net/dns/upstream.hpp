...
namespace psm::dns
{
    ...
    // bring detail types into dns namespace
    ...
    private:
         ...
         */
        [[nodiscard]] auto query_udp(const server &server, const message &query)
            -> net::awaitable<query_result>;
         ...
         * @return 协程对象，返回该上游的查询结果
         */
        [[nodiscard]] auto query_tcp(const server &server, const message &query)
            -> net::awaitable<query_result>;
         ...
         * @return 协程对象，返回该上游的查询结果
         */
        [[nodiscard]] auto query_tls(const server &server, const message &query)
            -> net::awaitable<query_result>;
         ...
         * @return 协程对象，返回该上游的查询结果
         */
        [[nodiscard]] auto query_https(const server &server, const message &query)
            -> net::awaitable<query_result>;
         ...
         * @return 协程对象，返回该上游的查询结果
         */
        [[nodiscard]] auto query_server(const server &server, const message &query)
            -> net::awaitable<query_result>;
