...
| 反向代理 | `src/forward-engine/transport/reverse.cpp`, `include/forward-engine/transport/reverse.hpp` | 运行链接入 |
...
| reverse_map 目标解析 | 域名优先 | IP literal 优先 | `src/forward-engine/transport/reverse.cpp` |
