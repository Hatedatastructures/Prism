...
- `interop/`：preview 与生产栈、外部实现的对拍记录——[psm-l4.md](interop/psm-l4.md)（L4 生产对拍，2026-08-20）；最新机器结果由 `scripts/interop/Run-Matrix.ps1` 写入 `build/interop-results/summary.json`。
