...
namespace Preview::Account
{
    ...
    public:
         ...
         * @brief 插入或更新条目
         * @param Credential 凭证
         * @param Options 条目限制参数
         */
        void Upsert(std::string_view Credential)
        {
            Upsert(Credential, UpsertOptions{});
        }
         ...
         * @param Options 条目限制参数
         */
        void Upsert(std::string_view Credential, UpsertOptions Options)
        {
            Entries_.Set(std::string(Credential),
                         std::make_shared<Entry>(Options.MaxConnections, Options.Disabled, Options.ExpireAt));
        }
         ...
         * @param MaxConnections 连接上限（0 = 无限制）
         */
        void Upsert(std::string_view Credential, std::uint32_t MaxConnections)
        {
            Upsert(Credential, UpsertOptions{MaxConnections});
        }
